...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $link = mysqli_connect("localhost", "root", "", "Rentalmag");
...
<!--PAGE 4-->
  <div class="avl-container hide-pop row" id="pg4">
	...
	<button type="submit" class="button-center hide-pop" id="bt">SUBMIT<i class="material-icons right sub-icon"></i></button>  
  </form>
